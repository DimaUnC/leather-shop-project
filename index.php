<?php
// 1. Твои реальные данные о товарах (расширения исправлены на строчные)
$products = [
    [
        "id" => 1,
        "name" => "Кошелек Bifold",
        "price" => 5800,
        "img" => "assets/img/bifold_1.jpg"
    ],
    [
        "id" => 2,
        "name" => "Картхолдер Simple",
        "price" => 2500,
        "img" => "assets/img/cardholder_1.jpg"
    ],
    [
        "id" => 3,
        "name" => "Картхолдер Double",
        "price" => 3200,
        "img" => "assets/img/cardholder_two_1.jpg"
    ],
    [
        "id" => 4,
        "name" => "Кошелек Longer",
        "price" => 7500,
        "img" => "assets/img/longer_1.jpg"
    ],
    [
        "id" => 5,
        "name" => "Обложка на паспорт",
        "price" => 3500,
        "img" => "assets/img/passport_wallet_1.jpg"
    ]
];
?>
<!DOCTYPE html>
            ...
            <?php foreach ($products as $p): ?>
                <div class="group border border-stone-800 p-4 rounded-2xl hover:border-[#c27854]/50 transition duration-500">
                    <div class="overflow-hidden rounded-xl mb-6">
                        <!-- Цветные сразу + зум 110% при наведении на карточку -->
                        <img src="<?php echo $p['img']; ?>" 
                             alt="<?php echo $p['name']; ?>"
                             class="product-img w-full h-80 object-cover group-hover:scale-110 transition duration-700">
                    </div>
                    <div class="flex justify-between items-center mb-2">
                        <h3 class="text-2xl"><?php echo $p['name']; ?></h3>
                        <span class="font-mono text-[#c27854] text-xl"><?php echo $p['price']; ?> ₽</span>
                    </div>
